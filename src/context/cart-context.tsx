...
type CartAction =
    | { type: 'ADD_ITEM'; payload: { product: Product; selectedVariants: { [key: string]: string }; quantity: number } }
...
export const CartProvider: React.FC<CartProviderProps> = ({ children }) => {
    ...
    const addToCart = (product: Product, selectedVariants: { [key: string]: string }, quantity: number = 1) => {
